...
class LaporanDistribusiDbrForm extends StatefulWidget {
  final String userRole;
  final String userDivisi;

  const LaporanDistribusiDbrForm({
    super.key,
  ...
  @override
  State<LaporanDistribusiDbrForm> createState() =>
      _LaporanDistribusiDbrFormState();
}

class _LaporanDistribusiDbrFormState extends State<LaporanDistribusiDbrForm> {
  String? durasi;
  String? bulan;
  String? tahun;
  ...
  void _cetakLaporan() async {
    ...
    try {
      // 🔹 Ambil data dari API khusus Distribusi DBR
      final res = await PindahtanganApi.getAllPerpindahanDBR();
        ...
        pw.MultiPage(
          ...
          build: (context) => [
            ...
            pw.Align(
              ...
              child: pw.Text(
                "Nomor Formulir : POM-14.01/CFM.01/SOP.01/IK.17A.01/F.04",
              ...
              data: [
                for (int i = 0; i < filteredData.length; i++)
                  [
                    ...
                    filteredData[i]['nup'] ?? "-",
                    "${filteredData[i]['old_lokasi'] ?? '-'} / ${filteredData[i]['nama_lokasi_lama'] ?? '-'}",
                    "${filteredData[i]['new_lokasi'] ?? '-'} / ${filteredData[i]['nama_lokasi_baru'] ?? '-'}",
                  ],
              ],
            ...
            pw.Row(
              ...
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                // Kolom 1 - Penanggung Jawab UAKPB
                pw.Expanded(
                  child: pw.Column(
                ...
                // Kolom 2 - Penanggung Jawab Ruangan
                pw.Expanded(
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.center,
                    children: [

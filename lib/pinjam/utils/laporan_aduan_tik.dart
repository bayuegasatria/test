...
class LaporanAduanTikForm extends StatefulWidget {
  final String userRole;
  final String userDivisi;

  const LaporanAduanTikForm({
    super.key,
  ...
  @override
  State<LaporanAduanTikForm> createState() => _LaporanAduanTikFormState();
}

class _LaporanAduanTikFormState extends State<LaporanAduanTikForm> {
  String? durasi;
  String? bulan;
  String? tahun;
  ...
  void _cetakLaporan() async {
    ...
    try {
      final res = await AduanTikApi.getAduanTIKData(
